...
example.exe: vt100.o vt100-tgetc.o history.o main.o server.o
	gcc -std=c99 -Wall -o example.exe vt100.o vt100-tgetc.o history.o main.o server.o  -static-libgcc -static-libstdc++ -Wl,-Bstatic -lstdc++ -lpthread -Wl,-Bdynamic -lwsock32 -lws2_32 -lsetupapi
...
server.o: ./example/server.c
	gcc -O3 -std=c99 -Wall -c ./example/server.c
    
main.o: ./example/main.c vt100-tgetc.h vt100.h history.h
